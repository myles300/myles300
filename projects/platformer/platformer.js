...
createPlatform(700,200,100,10);
    ...
    // example usage: createCollectable(type, x, y, gravity, bounce)
      createCollectable("diamond",700,100,0,0.5);
      createCollectable("diamond", 500,300,5,1);
      createCollectable("diamond",800,500,1,1 );
    ...
    createCannon("left",300,1000,10,10)
    createCannon("right",200,1000,10,10)
